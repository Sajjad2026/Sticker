...
class StickerContentProvider : ContentProvider() {
    ...
    override fun onCreate(): Boolean {
        ...
        val authority = Config.CONTENT_PROVIDER_AUTHORITY
    ...
    override fun getType(uri: Uri): String? =
        when (MATCHER.match(uri)) {
            METADATA_CODE -> "vnd.android.cursor.dir/vnd." + Config.CONTENT_PROVIDER_AUTHORITY + "." + METADATA
            METADATA_CODE_FOR_SINGLE_PACK -> "vnd.android.cursor.item/vnd." + Config.CONTENT_PROVIDER_AUTHORITY + "." + METADATA
            STICKERS_CODE -> "vnd.android.cursor.dir/vnd." + Config.CONTENT_PROVIDER_AUTHORITY + "." + STICKERS
    ...
    private fun getStickerPackInfo(uri: Uri, stickerPackList: List<StickerPackView>): Cursor {
        ...
        for (stickerPack in stickerPackList) {
            ...
            builder.add("https://www.google.com")
            builder.add(stickerPack.privacyPolicyWebsite)
            builder.add(stickerPack.licenseAgreementWebsite)
            builder.add(if (stickerPack.animatedStickerPack) 1 else 0)

        }
        Log.d(TAG, "getStickerPackInfo: $stickerPackList")
    ...
    private fun String.getLastBitFromUrl(): String = replaceFirst(".*/([^/?]+).*".toRegex(), "$1")
